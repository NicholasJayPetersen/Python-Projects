...
def get_number(prompt, low, high):
    while True:
        try:
            ...
            print("Only integer and decimal numbers are allowed. Try again.")
...
def get_integer(prompt, low, high):
    while True:
        try:
            ...
            print("Number cannot be a decimal or aphabetic characters. Whole numbers only. Please try agian.")
